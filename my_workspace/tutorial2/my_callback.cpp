...
class my_callback : public OASIS::Pin::Tool <my_callback>
{
public:
  my_callback (void) { this->enable_fini_callback (); }
...
KNOB <string> my_callback::outfile_ (KNOB_MODE_WRITEONCE, "pintool", "o", "my_callback.out", "specify output file name");

DECLARE_PINTOOL (my_callback);